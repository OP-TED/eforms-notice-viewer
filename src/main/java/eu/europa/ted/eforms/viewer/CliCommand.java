...
class CliCommand implements Callable<Integer> {
  ...
  @Option(names = {"-p", "--noticeXmlPath"}, description = "Path of XML file to view.",
      interactive = true, prompt = "Notice XML path: ", echo = true, arity = "0..1",
      required = true)
  ...
  @Option(names = {"-l", "--language"}, description = "Two letter language code.",
      interactive = true, prompt = "Language: ", echo = true, arity = "0..1", required = true)
