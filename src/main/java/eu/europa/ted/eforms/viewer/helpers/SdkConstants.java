...
public class SdkConstants {
  ...
  public static enum ResourceType {
    CODELISTS(Path.of("codelists")), NOTICE_TYPES_VIEW_TEMPLATE(Path.of("view-templates")), SDK_FIELD(Path.of("fields")), TRANSLATION(Path.of("translations")), SDK_FIELDS_FIELDS_JSON(Path.of("fields", "fields.json"));
